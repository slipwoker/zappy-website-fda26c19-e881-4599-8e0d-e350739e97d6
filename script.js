  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.minLength && field.minLength > 0 && value.length < field.minLength) {
        showError(field, fieldLabel + ' must be at least ' + field.minLength + ' characters.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fda26c19-e881-4599-8e0d-e350739e97d6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fda26c19-e881-4599-8e0d-e350739e97d6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fda26c19-e881-4599-8e0d-e350739e97d6';
